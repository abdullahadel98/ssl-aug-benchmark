...
pbt_params = {'interval': 1, 'trials': 24, 'resample_probability': 0.0, 'burn_in_period': 5.0, 'metric': 'sum_losses', 'mode': 'min'}
pbt_hyperparams = {"synth_ratio": 0.5, "stylize_prob_orig": 0.2, "stylize_prob_synth": 0.2, "alpha_min_real": 1.0, "alpha_min_synth": 1.0}
